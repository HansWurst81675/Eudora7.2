...
Stand **17.09.2026**. Die Urteile in dieser Tabelle sind an Fassung **7.2.0.55 / Paket 1.0.55** gemessen; gebaut ist inzwischen **7.2.0.72** (E-88, E-89, E-93, E-95, E-96, E-97, E-99, E-100, E-101, E-103, E-104, E-106, E-108 — **171/171 Tests**). **E-97** (*File → Save As* stürzte ab) und **E-99** (Datenverlust beim Senden eines gesicherten Entwurfs) hat Gregor am 17.09.2026 an **1.0.64** bestätigt; **E-100** (7.2.0.65), **E-101** (7.2.0.66 erster, 7.2.0.69 zweiter Teil), **E-103** (7.2.0.67), **E-104** (7.2.0.67 und 7.2.0.68) und **E-106** (7.2.0.68) sind von ihm noch nicht am laufenden Programm beurteilt; **E-106 ist ausdrücklich nicht nachgewiesen** — mein Prüfstand lädt die Bilder nicht, nur Gregors Lauf kann es belegen. **Offen aus derselben Ecke: E-98** — die beiden Optionen *Kopfzeilen einschließen* und *Absätze raten* fehlen im Speicherdialog, weil Windows 10 die Dialogvorlage von 1996 nicht mehr anzeigt; das berührt **Kriterium 4** nicht (kein Absturz), wohl aber die Bedienbarkeit. Als Paket geschnürt ist **1.0.70** (17.09.2026, 21:18) — das erste, das alles enthält; bei Gregor liegen 1.0.65, 1.0.67, 1.0.68 und 1.0.69, **1.0.70 noch nicht**.
