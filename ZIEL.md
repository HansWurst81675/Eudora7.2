...
Stand **18.09.2026**. Die Urteile in dieser Tabelle sind an Fassung **7.2.0.55 / Paket 1.0.55** gemessen; gebaut ist inzwischen **7.2.0.76** — darin sind **E-110** (Bilder kamen beim Antworten nicht mit; `resolve_URL` warf jede Prozent-Sequenz weg, von Gregor an 1.0.75 bestätigt) und **E-112** (die Bilder erschienen danach in Originalgröße statt in der angegebenen, Regression der E-106-Behebung, noch nicht bestätigt) behoben, dazu **E-113** neu aufgeschrieben; der letzte **veröffentlichte** Stand bleibt **7.2.0.72** (E-88, E-89, E-93, E-95, E-96, E-97, E-99, E-100, E-101, E-103, E-104, E-106, E-108 — **171/171 Tests**), und genau dieser Stand ist am 17.09.2026 um 20:07:49 UTC als **`v1.0.72`** auf GitHub veröffentlicht, dort als *Latest*. **Von Gregor am laufenden Programm bestätigt:** **E-97** (*File → Save As* stürzte ab) und **E-99** (Datenverlust beim Senden eines gesicherten Entwurfs) an **1.0.64**, **E-106** (Bilder über dem Text) an **1.0.69** — sein Bildschirmfoto zeigt die Überlappung weg —, und **E-108** (Absturz beim Antworten) an **1.0.72**: *„kein crash"*, sein Protokoll läuft über die bisher tödliche Stelle hinaus bis `Logging shutdown`, ohne `Exception.log`. **Noch nicht von ihm beurteilt** sind **E-100** (7.2.0.65), **E-101** (7.2.0.66 erster, 7.2.0.69 zweiter Teil), **E-103** (7.2.0.67) und **E-104** (7.2.0.67 und 7.2.0.68) — alle vier stecken im Download `v1.0.72`, es fehlt allein sein Urteil. **Offen aus derselben Ecke: E-98** — die beiden Optionen *Kopfzeilen einschließen* und *Absätze raten* fehlen im Speicherdialog, weil Windows 10 die Dialogvorlage von 1996 nicht mehr anzeigt; das berührt **Kriterium 4** nicht (kein Absturz), wohl aber die Bedienbarkeit. **1.0.70 ist nie geschnürt zu Gregor gelangt, 1.0.71 stürzt beim Antworten ab und ist nie veröffentlicht worden**; bei ihm liegen 1.0.65, 1.0.67, 1.0.68, 1.0.69, 1.0.71 und 1.0.72.

> **Berichtigt am 18.09.2026 (LEKTOR, L-15.2).** Hier stand *„Als Paket
> geschnürt ist **1.0.70** … das erste, das alles enthält; bei Gregor liegen
> 1.0.65, 1.0.67, 1.0.68 und 1.0.69, **1.0.70 noch nicht**"* — und **E-106**
> galt als *„ausdrücklich nicht nachgewiesen"*. Beides ist überholt: das
> Release `v1.0.72` war zu diesem Zeitpunkt schon draußen (`gh release list`),
> und E-106 hat Gregor an 1.0.69 bestätigt. Vom Release stand in dieser Zeile
> kein Wort.
