...
Stand **17.09.2026**. Die Urteile in dieser Tabelle sind an Fassung **7.2.0.55 / Paket 1.0.55** gemessen; gebaut ist inzwischen **7.2.0.68** (E-88, E-89, E-93, E-95, E-96, E-97, E-99, E-100, E-101, E-103, E-104, E-106, E-107, E-108 — **169/169 Tests**). **E-97** (*File → Save As* stürzte ab) und **E-99** (Datenverlust beim Senden eines gesicherten Entwurfs) hat Gregor am 17.09.2026 an **1.0.64** bestätigt; **E-100** (7.2.0.65) und **E-101** (7.2.0.68) sind von ihm noch nicht am laufenden Programm beurteilt. **Offen aus derselben Ecke: E-98** — die beiden Optionen *Kopfzeilen einschließen* und *Absätze raten* fehlen im Speicherdialog, weil Windows 10 die Dialogvorlage von 1996 nicht mehr anzeigt; das berührt **Kriterium 4** nicht (kein Absturz), wohl aber die Bedienbarkeit. Als Paket geschnürt ist zuletzt **1.0.65**; **zu 1.0.68 gibt es noch kein Paket** (gemessen am 17.09.2026 unter `Releases/`).
