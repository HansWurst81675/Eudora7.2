...
| **Zuletzt gebaut** | Quellstand **7.2.0.70** / `VERSION` **1.0.70**, gebaut am 17.09.2026, 21:18 (**171/171 Tests**) — **das erste Paket, das alles enthält**: E-101 in beiden Teilen, E-103, E-104, E-106. Gemessen an der `Eudora.exe` jedes Pakets (Produktversion und Zeitstempel): das Verzeichnis `Releases/Eudora72-1.0.70-release` und das ZIP dazu liegen da. **Bei Gregor liegen 1.0.65, 1.0.67, 1.0.68 und 1.0.69 — 1.0.70 noch nicht.** **Was in seinem 1.0.69 wirklich steckt** (Exe vom 17.09., 20:24:54, Stand `acc8ad7`): **E-106 ist darin** (Merge `0334a6c`, 20:16:00, ist Vorfahr), **E-101 Teil 2 ist NICHT darin** (`e27ccf1`, 20:58:43, entstand danach). **Auf GitHub veröffentlicht ist `v1.0.64`** (17.09.2026, 10:23 Uhr UTC, als *Latest* markiert); **1.0.65 bis 1.0.70 sind nicht freigegeben**. Aus Gregors Lauf mit **1.0.58** am 14.09.2026 stammen **E-89**, **E-90** (offen), **E-91** (offen) und **E-92** (offen); **E-95** meldete er an 1.0.60, **E-96** ist am 15.09.2026 an einem selbst gestarteten Eudora mit drei Bildern bekannter Größe gemessen worden. Bei 1.0.51 zeigte sein Test den Fehler E-85 noch, ab 1.0.52 ist E-85 behoben und belegt |
