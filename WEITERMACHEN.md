...
| **VON GREGOR ZU PRÜFEN, 17.09.2026 — E-101** | **die gespeicherte Datei ist jetzt für andere Programme brauchbar.** Gebaut in **7.2.0.66** (**160/160 Tests**, sieben davon neu), **am laufenden Programm von mir geprüft, von Gregor noch nicht bestätigt.** Prüfanleitung in [CHANGELOG.md](CHANGELOG.md), Abschnitt 7.2.0.66, *Zum Prüfen*: eine Nachricht über *File → Save As* sichern und die Datei in einem anderen Programm (Thunderbird, Editor) öffnen. **Was zu sehen sein muss:** `MIME-Version: 1.0` und `Content-Type: text/html; charset="ISO-8859-1"` in den Kopfzeilen, **kein** `<x-html>`, und die Umlaute stehen richtig da |
...
| **Zuletzt gebaut** | Quellstand **7.2.0.66** / `VERSION` **1.0.66**, gebaut am 17.09.2026 (**E-101**, 160/160 Tests). **Ein Paket dazu ist noch nicht geschnürt** — gemessen am 17.09.2026: unter `Releases/` liegt zuletzt das Verzeichnis `Eudora72-1.0.65-release`, das letzte ZIP ist `Eudora72-1.0.64-release.zip`. **Auf GitHub veröffentlicht ist weiterhin `v1.0.50`**; **1.0.51 bis 1.0.66 sind nicht freigegeben**. Aus Gregors Lauf mit **1.0.58** am 14.09.2026 stammen **E-89**, **E-90** (offen), **E-91** (offen) und **E-92** (offen); **E-95** meldete er an 1.0.60, **E-96** ist am 15.09.2026 an einem selbst gestarteten Eudora mit drei Bildern bekannter Größe gemessen worden. Bei 1.0.51 zeigte sein Test den Fehler E-85 noch, ab 1.0.52 ist E-85 behoben und belegt |
