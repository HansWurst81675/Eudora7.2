...
| | |
|---|---|
| **Quellstand** | 7.2.0.57 (`Eudora71/Version.h`) |
| **Paketnummer** | 1.0.57 (`VERSION`) |
| **VON GREGOR ZU PRÜFEN, 14.09.2026 — E-89** | **im Verfassenfenster liegen die Bilder nicht mehr über dem Text.** Gebaut in 7.2.0.57 (0 Fehler, 148/148 Tests, 17 davon neu), **am laufenden Programm noch nicht bestätigt.** Prüfanleitung in [CHANGELOG.md](CHANGELOG.md), Abschnitt 7.2.0.57, *Zum Prüfen*: `LogLevel=58527`, einen Newsletter mit Bildern weiterleiten, dann im Protokoll nach `E-89` suchen. **Was zu sehen sein muss: nichts liegt übereinander, jeder Satz ist lesbar.** Kästen und Hintergründe erscheinen weiterhin nicht — Paige kann kein CSS, und der Maßstab ist Lesbarkeit, nicht Aussehen. **Im selben Lauf muss E-88 weiter tragen:** die Zeilen `E-88 vor dem Absenden` und `E-88 auf der Leitung` müssen `Fassung=ORIGINAL` sagen. Sagen sie das nicht mehr, hat E-89 dem Befund E-88 etwas weggenommen |
...
| **Zuletzt gebaut und gepackt** | Paket **1.0.56** (Quellstand 7.2.0.56), unter `Releases/Eudora72-1.0.56-release`. Gregor hat es am 14.09.2026 laufen lassen — aus diesem Lauf stammen **E-89** bis **E-92**. **Auf GitHub veröffentlicht ist weiterhin `v1.0.50`**; 1.0.51 bis 1.0.56 sind **nicht freigegeben**. Bei 1.0.51 zeigte sein Test den Fehler E-85 noch, ab 1.0.52 ist E-85 behoben und belegt |
...
|---|---|
| **E-89** | das Verfassenfenster ist unbrauchbar: Bilder überlagern den Text, man kann nicht lesen, w… |
