...
| **Paketnummer** | 1.0.75 (`VERSION`) — **E-110 behoben**: `resolve_URL` rückt den Ausgabezeiger im `%`-Zweig wieder weiter, Bilder mit Leerzeichen im Namen kommen wieder an. 178 Tests, 178 bestanden; die Gegenprobe ohne die Behebung lässt vier davon umfallen |
