...
| **Zuletzt gebaut und gepackt** | Paket **1.0.58** (Quellstand 7.2.0.58), unter `Releases/Eudora72-1.0.58-release`. Gregor hat es am 14.09.2026 laufen lassen — aus diesem Lauf stammen **E-89** bis **E-92**. **Auf GitHub veröffentlicht ist weiterhin `v1.0.50`**; 1.0.51 bis 1.0.56 sind **nicht freigegeben**. Bei 1.0.51 zeigte sein Test den Fehler E-85 noch, ab 1.0.52 ist E-85 behoben und belegt |
