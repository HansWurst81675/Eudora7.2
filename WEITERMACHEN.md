...
| | |
|---|---|
| **Quellstand** | 7.2.0.66 (`Eudora71/Version.h`) |
| **Paketnummer** | 1.0.66 (`VERSION`) |
| **VON GREGOR ZU PRÜFEN, 17.09.2026 — E-101** | **die gespeicherte Datei ist jetzt für andere Programme brauchbar.** Gebaut in **7.2.0.66** (**166/166 Tests** — sieben neue zur Behebung selbst, sechs weitere zu den vier Datenverlusten, die der PRÜFER *in dieser Behebung* gemessen hat, **P-18 bis P-22**, `Befunde/PRUEFER-13.md`), **am laufenden Programm von mir geprüft, von Gregor noch nicht bestätigt.** **Sein Urteil zur ersten Fassung war „so nicht ausliefern"** — vor dem Prüfen die Geschichte unter **E-101** in [BEFUNDE.md](BEFUNDE.md) lesen. Prüfanleitung in [CHANGELOG.md](CHANGELOG.md), Abschnitt 7.2.0.66, *Zum Prüfen*: eine Nachricht über *File → Save As* sichern und die Datei in einem anderen Programm (Thunderbird, Editor) öffnen. **Was zu sehen sein muss:** `MIME-Version: 1.0` und `Content-Type: text/html; charset="ISO-8859-1"` in den Kopfzeilen, **kein** `<x-html>`, und die Umlaute stehen richtig da |
...
| **Zuletzt gebaut** | Quellstand **7.2.0.66** / `VERSION` **1.0.66**, gebaut am 17.09.2026 (**E-101**, **166/166 Tests** — 160 waren es vor den sechs Tests zu den vom PRÜFER gemessenen Datenverlusten P-18 bis P-22). **Ein Paket dazu ist noch nicht geschnürt** — gemessen am 17.09.2026: unter `Releases/` liegt zuletzt das Verzeichnis `Eudora72-1.0.65-release`, das letzte ZIP ist `Eudora72-1.0.64-release.zip`. **Auf GitHub veröffentlicht ist `v1.0.64`** (17.09.2026, 10:23 Uhr UTC, dort als *Latest*); **1.0.65 und 1.0.66 sind nicht freigegeben**. **Berichtigt am 17.09.2026 (LEKTOR, L-13.1): hier stand „veröffentlicht ist weiterhin `v1.0.50`; 1.0.51 bis 1.0.66 sind nicht freigegeben" — gemessen mit `gh release list` ist das falsch.** Aus Gregors Lauf mit **1.0.58** am 14.09.2026 stammen **E-89**, **E-90** (offen), **E-91** (offen) und **E-92** (offen); **E-95** meldete er an 1.0.60, **E-96** ist am 15.09.2026 an einem selbst gestarteten Eudora mit drei Bildern bekannter Größe gemessen worden. Bei 1.0.51 zeigte sein Test den Fehler E-85 noch, ab 1.0.52 ist E-85 behoben und belegt |
