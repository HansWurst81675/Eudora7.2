...
| **Zuletzt gebaut und gepackt** | Paket **1.0.29** — `Releases/Eudora72-1.0.29-release.zip`, 9 342 274 B, SHA256 `cf60bb3a806204ea…`, veröffentlicht als [v1.0.29](https://github.com/HansWurst81675/Eudora7.2/releases/tag/v1.0.29) (Marke auf `15a7cb8`). Prüfsummen aller Pakete in [Releases/PAKETE.md](Releases/PAKETE.md) |
| **Zuletzt von Gregor bestätigt** | **1.0.29 am 09.09.2026**: die sechs Prüfpunkte zu **E-54** bis **E-58** und **E-61** sind in Ordnung — *„1-6, ok"* —, dazu ungefragt gelobt: *„rechtklick zeigt ja einen liste der offenen fenster: sehr gut."* **Ein Restfehler**, von ihm mit Bildschirmfoto gemeldet und bewusst zurückgestellt: die **letzte** Registerkarte zeigt keinen Kurzhinweis (**E-63**). Davor **A-3 an 1.0.25**: der Klick auf eine Karte holt das Fenster nach vorn, die Beschriftungen stimmen mit dem Menü *Window* — damit ist **Kriterium 8** erfüllt; am selben Tag die **Höhenänderung** des unteren Bereichs (*„verschieben rauf / runter — bug gefixt"*), drei Mängel an der Kartenleiste (**E-50**, in 1.0.26 behoben) und ein **Nebenbefund ohne Nummer**: nach einem Neustart stehen die Fenster nicht im Vollbild. Davor **1.0.24**: *„persona läßt sich löschen. keine messagebox"* (**E-43**, und mit ihm **E-37** und **E-38**) |
| **Was als Nächstes zu messen ist** | **E-63** — der Kurzhinweis der letzten Registerkarte. Gregors Freigabe dazu: *„den fehler notieren wir, wird im nächsten release behoben."* Was noch **niemand** gemessen hat, weil es nur ein Mensch kann: das **Ziehen** des Trennbalkens (**A-4**, Befunde **E-49**, **E-52**, **E-54**, **E-55**) — wird der Zeiger auf der Kante zum Doppelpfeil, lässt sich der linke Bereich über 180 Pixel hinaus breiter ziehen, bleibt der Balken danach **gleich noch einmal** greifbar, überlebt die Breite einen Neustart, und **friert nichts ein**? Der letzte Punkt zuerst: die Ziehschleife hat in meinen eigenen Tests zweimal die Prüfinstanz eingefroren, bevor sie abgesichert war (**E-51**), und **E-61** hat gezeigt, dass dieselbe Schleife das Beenden verschlucken konnte |
