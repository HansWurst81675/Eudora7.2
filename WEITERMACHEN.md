...
| **Zuletzt gebaut und gepackt** | Paket **1.0.63** (Quellstand 7.2.0.63), unter `Releases/Eudora72-1.0.63-release`. **Auf GitHub veröffentlicht ist weiterhin `v1.0.50`**; **1.0.51 bis 1.0.63 sind nicht freigegeben**. Aus Gregors Lauf mit **1.0.58** am 14.09.2026 stammen **E-89**, **E-90** (offen), **E-91** (offen) und **E-92** (offen); **E-95** meldete er an 1.0.60, **E-96** ist am 15.09.2026 an einem selbst gestarteten Eudora mit drei Bildern bekannter Größe gemessen worden. Bei 1.0.51 zeigte sein Test den Fehler E-85 noch, ab 1.0.52 ist E-85 behoben und belegt |
...
|---|---|
| **E-97** | Eudora stürzt ab, sobald eine Nachricht gespeichert werden soll — *„da kommt kurz ein… |
