...
|---|---|---|
| **Quellstand**, z. B. `7.2.0.40` | `Eudora71/Version.h` | die Produktversion, die ein Bau in die `Eudora.exe` schreibt. Sie steht in der Dateiinfo und in der Titelzeile |
| **Paketnummer**, z. B. `1.0.40` | die Datei `VERSION` | benennt das ausgelieferte ZIP |
