...
> Quellstand **7.2.0.54**, Paketnummer **1.0.54** — gebaut für Gregors Test von
...
> **Erledigt am 13.09.2026 als E-85.** Genau diese Umstellung ist in 7.2.0.51
> gebaut: `ImapDownload.cpp:4671` ruft jetzt `FindMIMECharset(params->value)`,
> die Wächterbedingung darunter heißt `if (iCharsetIdx > 2)` (`:4688`) statt
> `> 1`, und damit rechnen POP3 und IMAP auf **derselben** Skala. Am Quelltext
> belegt, von Gregor noch nicht am laufenden Programm bestätigt — Einzelheiten
> unter **E-85** in `BEFUNDE.md`.
...
> (`:4705-4711`). `TextReader.cpp` hatte es schon richtig.
...
> `ImapDownload.cpp:4705` benutzen dieselbe. Sie hält die angefangenen Bytes
