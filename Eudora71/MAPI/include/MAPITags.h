...
#define PR_IN_REPLY_TO								PROP_TAG( PT_TSTRING,	0x1042)
#define PR_IN_REPLY_TO_W							PROP_TAG( PT_UNICODE,	0x1042)
#define PR_IN_REPLY_TO_A							PROP_TAG( PT_STRING8,	0x1042)
...
/*
 * Received by SMTP addresses
 */
#define PR_RECEIVED_BY_SMTP_ADDRESS					PROP_TAG( PT_TSTRING,	0x5D07)
#define PR_RECEIVED_BY_SMTP_ADDRESS_W				PROP_TAG( PT_UNICODE,	0x5D07)
#define PR_RECEIVED_BY_SMTP_ADDRESS_A				PROP_TAG( PT_STRING8,	0x5D07)
#define PR_RCVD_REPRESENTING_SMTP_ADDRESS			PROP_TAG( PT_TSTRING,	0x5D08)
#define PR_RCVD_REPRESENTING_SMTP_ADDRESS_W			PROP_TAG( PT_UNICODE,	0x5D08)
#define PR_RCVD_REPRESENTING_SMTP_ADDRESS_A			PROP_TAG( PT_STRING8,	0x5D08)
