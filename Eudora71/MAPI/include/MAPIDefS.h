...
/* PR_ICON_INDEX values */
#define ICON_INDEX_NEW_MAIL			((LONG) 0xFFFFFFFF)
#define ICON_INDEX_POST				((LONG) 0x00000001)
#define ICON_INDEX_OTHER			((LONG) 0x00000003)

/* PR_ICON_INDEX values: Mail */
#define ICON_INDEX_READ_MAIL			((LONG) 0x00000100)
#define ICON_INDEX_UNREAD_MAIL			((LONG) 0x00000101)
#define ICON_INDEX_SUBMITTED_MAIL		((LONG) 0x00000102)
#define ICON_INDEX_UNSENT_MAIL			((LONG) 0x00000103)
#define ICON_INDEX_RECEIPT_MAIL			((LONG) 0x00000104)
#define ICON_INDEX_REPLIED_MAIL			((LONG) 0x00000105)
#define ICON_INDEX_FORWARDED_MAIL		((LONG) 0x00000106)
#define ICON_INDEX_REMOTE_MAIL			((LONG) 0x00000107)
#define ICON_INDEX_DELIVERY_MAIL		((LONG) 0x00000108)
#define ICON_INDEX_READ_RECEIPT_MAIL	((LONG) 0x00000109)
#define ICON_INDEX_NONDELIVERY_MAIL		((LONG) 0x0000010A)
#define ICON_INDEX_NONREAD_MAIL			((LONG) 0x0000010B)
#define ICON_INDEX_RECALL_S_MAIL		((LONG) 0x0000010C)
#define ICON_INDEX_RECALL_F_MAIL		((LONG) 0x0000010D)
#define ICON_INDEX_TRACKING_MAIL		((LONG) 0x0000010E)

/* PR_ICON_INDEX values: S/MIME mail */
#define ICON_INDEX_MAIL_SIGNED					((LONG) 0x0000010F)
#define ICON_INDEX_MAIL_ENCRYPTED				((LONG) 0x00000110)
#define ICON_INDEX_MAIL_SMIME_SIGNED			((LONG) 0x00000111)
#define ICON_INDEX_MAIL_SMIME_RECEIPT			((LONG) 0x00000112)
#define ICON_INDEX_MAIL_ENCRYPTED_REPLIED		((LONG) 0x00000113)
#define ICON_INDEX_MAIL_SMIME_SIGNED_REPLIED	((LONG) 0x00000114)
#define ICON_INDEX_MAIL_ENCRYPTED_FORWARDED		((LONG) 0x00000115)
#define ICON_INDEX_MAIL_SMIME_SIGNED_FORWARDED	((LONG) 0x00000116)
#define ICON_INDEX_MAIL_ENCRYPTED_READ			((LONG) 0x00000117)
#define ICON_INDEX_MAIL_SMIME_SIGNED_READ		((LONG) 0x00000118)

/* PR_ICON_INDEX values: Additional mail */
#define ICON_INDEX_OUT_OF_OFFICE_MAIL	((LONG) 0x0000011B)
#define ICON_INDEX_RECALL_MAIL			((LONG) 0x0000011C)
#define ICON_INDEX_TRACKED_MAIL			((LONG) 0x00000130)

/* PR_ICON_INDEX values: IRM mail */
#define ICON_INDEX_IRM_READ_MAIL		((LONG) 0x00000131)
#define ICON_INDEX_IRM_UNREAD_MAIL		((LONG) 0x00000132)
#define ICON_INDEX_IRM_FORWARDED_MAIL	((LONG) 0x00000133)
#define ICON_INDEX_IRM_REPLIED_MAIL		((LONG) 0x00000134)
#define ICON_INDEX_IRM_COMPOSE_MAIL		((LONG) 0x00000135)

/* PR_ICON_INDEX values: Contact */
#define ICON_INDEX_CONTACT				((LONG) 0x00000200)
#define ICON_INDEX_DISTRIBUTION_LIST	((LONG) 0x00000202)

/* PR_ICON_INDEX values: Sticky note */
#define ICON_INDEX_STICKY_NOTE_BLUE		((LONG) 0x00000300)
#define ICON_INDEX_STICKY_NOTE_GREEN	((LONG) 0x00000301)
#define ICON_INDEX_STICKY_NOTE_PINK		((LONG) 0x00000302)
#define ICON_INDEX_STICKY_NOTE_YELLOW	((LONG) 0x00000303)
#define ICON_INDEX_STICKY_NOTE_WHITE	((LONG) 0x00000304)

/* PR_ICON_INDEX values: Calendar */
#define ICON_INDEX_SINGLE_INSTANCE_APPOINTMENT	((LONG) 0x00000400)
#define ICON_INDEX_RECURRING_APPOINTMENT		((LONG) 0x00000401)
#define ICON_INDEX_SINGLE_INSTANCE_MEETING		((LONG) 0x00000402)
#define ICON_INDEX_RECURRING_MEETING			((LONG) 0x00000403)
#define ICON_INDEX_MEETING_REQUEST				((LONG) 0x00000404)
#define ICON_INDEX_ACCEPT						((LONG) 0x00000405)
#define ICON_INDEX_DECLINE						((LONG) 0x00000406)
#define ICON_INDEX_TENTATIVE					((LONG) 0x00000407)
#define ICON_INDEX_CANCELATION					((LONG) 0x00000408)
#define ICON_INDEX_INFORMATIONAL_UPDATE			((LONG) 0x00000409)

/* PR_ICON_INDEX values: Task */
#define ICON_INDEX_TASK							((LONG) 0x00000500)
#define ICON_INDEX_UNASSIGNED_RECURRING_TASK	((LONG) 0x00000501)
#define ICON_INDEX_ASSIGNEE_TASK				((LONG) 0x00000502)
#define ICON_INDEX_ASSIGNER_TASK				((LONG) 0x00000503)
#define ICON_INDEX_TASK_REQUEST					((LONG) 0x00000504)
#define ICON_INDEX_TASK_ACCEPTANCE				((LONG) 0x00000505)
#define ICON_INDEX_TASK_REJECTION				((LONG) 0x00000506)

/* PR_ICON_INDEX values: Journal */
#define ICON_INDEX_JOURNAL_CONVERSATION						((LONG) 0x00000601)
#define ICON_INDEX_JOURNAL_EMAIL_MESSAGE					((LONG) 0x00000602)
#define ICON_INDEX_JOURNAL_MEETING_REQUEST					((LONG) 0x00000603)
#define ICON_INDEX_JOURNAL_MEETING_RESPONSE					((LONG) 0x00000604)
#define ICON_INDEX_JOURNAL_TASK_REQUEST						((LONG) 0x00000606)
#define ICON_INDEX_JOURNAL_TASK_RESPONSE					((LONG) 0x00000607)
#define ICON_INDEX_JOURNAL_NOTE								((LONG) 0x00000608)
#define ICON_INDEX_JOURNAL_FAX								((LONG) 0x00000609)
#define ICON_INDEX_JOURNAL_PHONE_CALL						((LONG) 0x0000060A)
#define ICON_INDEX_JOURNAL_LETTER							((LONG) 0x0000060C)
#define ICON_INDEX_JOURNAL_MICROSOFT_OFFICE_WORD			((LONG) 0x0000060D)
#define ICON_INDEX_JOURNAL_MICROSOFT_OFFICE_EXCEL			((LONG) 0x0000060E)
#define ICON_INDEX_JOURNAL_MICROSOFT_OFFICE_POWER_POINT		((LONG) 0x0000060F)
#define ICON_INDEX_JOURNAL_MICROSOFT_OFFICE_ACCESS			((LONG) 0x00000610)
#define ICON_INDEX_JOURNAL_DOCUMENT							((LONG) 0x00000612)
#define ICON_INDEX_JOURNAL_MEETING							((LONG) 0x00000613)
#define ICON_INDEX_JOURNAL_MEETING_CANCELLATION				((LONG) 0x00000614)
#define ICON_INDEX_JOURNAL_REMOTE_SESSION					((LONG) 0x00000615)
...
#define ATTACH_BY_WEBREFERENCE	((ULONG) 0x00000007)
