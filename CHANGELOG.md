...
| Kennung | | |
|---|---|---|
| **E-89** | **das Verfassenfenster ist unbrauchbar: Bilder überlagern den Text**, man kann nicht lesen, was man schreibt | Von Gregor am 14.09.2026 an 1.0.56 gemeldet: *„1 und da ist alles durcheinander, man kann ja nichts lesen."* **Ursache gemessen:** Paige zeichnet Bilder in Originalgröße, wenn die Größe nur im CSS steht — 162 der 1506 `<img>` in Gregors Postfach tun das, und Paiges HTML-Leser kennt keine CSS-Eigenschaft (`PGHTMDEF.C:20-48`). **Seit E-88 ein reines Anzeigeproblem:** hinaus geht das aufgehobene Original, nicht die Editorfassung. **Zielbild ist Thunderbird** — nicht dessen Aussehen (dort bearbeitet Gecko), sondern die Schwelle *„nichts überlappt, jeder Satz lesbar"*. Der Maßstab heißt **„nie breiter als der verfügbare Raum"**, nicht „Originalgröße vermeiden": ein Bild mit auswertbarem, aber zu breitem HTML-Attribut sprengt die Zeile genauso. **Offen**, der Prüfer arbeitet daran |
