...
| NP3-9 | Rückgabewert von `ISOTranslate` an zwei Stellen verworfen | **behoben**, von Gregor an 1.0.51 bestaetigt (die Umlaute kamen richtig an, siehe E-85) — POP schon früher, **IMAP in 7.2.0.51** (`ImapDownload.cpp`, `inLen`/`outLen` werden nachgezogen). Auch dieser Befund stand bereits hier, als derselbe Mangel unter **E-85** neu gesucht wurde |
...
| S-2 | Stapelüberlauf beim Start — die Werbefläche mit `CRect(0,0,0,0)` | **behoben** am 30.08.2026, am laufenden Programm gemessen: Eudora kommt seither ueber den Startbildschirm hinaus |
...
| S-5 | Menüs ließen sich nicht öffnen | **behoben**, am laufenden Programm gemessen: die Menues klappen auf (Ursache M-1, belegt in E-1) |
